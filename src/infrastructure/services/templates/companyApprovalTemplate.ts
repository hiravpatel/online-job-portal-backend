export const companyApprovalTemplate = (companyName: string, loginUrl: string) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <style>
    ...
    .btn { background-color: #10b981; color: #ffffff !important; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500; display: inline-block; transition: background-color 0.2s; }
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Great news! Your company profile has been officially approved by our administration team.</p>
      <p>You can now log in to post jobs, review applications, and manage your company presence on the platform.</p>
